...
$(".main-header .logo-header").html(logoHeaderContent),
  ...
  $(document).ready(function () {
    ...
    if (!g) {
      ...
      $(".wrapper").hasClass("sidebar_minimize") && (_.addClass("toggled"), _.html('<i class="lni lni-menu-hamburger-1"></i>'), (f = 1)),
        _.on("click", function () {
          1 == f
            ? ($(".wrapper").removeClass("sidebar_minimize"), _.removeClass("toggled"), _.html('<i class="lni lni-menu-hamburger-1"></i>'), (f = 0))
            : ($(".wrapper").addClass("sidebar_minimize"), _.addClass("toggled"), _.html('<i class="bi bi-three-dots-vertical"></i>'), (f = 1)),
            $(window).resize();
        }),
        (g = !0),
        (u = !0);
    ...
    $(".wrapper").hasClass("is-show") && ((C = 1), y.addClass("toggled"), y.html('<i class="lni lni-menu-hamburger-1"></i>')),
      y.on("click", function () {
        1 == C
          ? ($(".wrapper").removeClass("is-show"), y.removeClass("toggled"), y.html('<i class="lni lni-menu-hamburger-1"></i>'), (C = 0))
          : ($(".wrapper").addClass("is-show"), y.addClass("toggled"), y.html('<i class="lni lni-menu-hamburger-1"></i>'), (C = 1)),
          $(window).resize();
      }),
      (g = !0),
      $(".sidebar")
